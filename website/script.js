document.addEventListener("DOMContentLoaded", () => {
  ...
  const artifactTrigger = document.getElementById("artifact-trigger");
  const artifactDialog = document.getElementById("artifact-dialog");
  artifactTrigger?.addEventListener("click", () => {
    if (typeof artifactDialog?.showModal === "function") artifactDialog.showModal();
    else artifactDialog?.setAttribute("open", "");
  });
